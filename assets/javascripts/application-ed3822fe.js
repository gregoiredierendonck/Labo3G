...
(function() {
  var $header, $navbutton, $root, anchorLinks, eventType, header_height, hero_height, link, navSlide, offset_val, openMenu, smallMenu;
  ...
  anchorLinks = function() {
    return $('a[href^="#"]').on('click', function(e) {
      ...
      return $('html, body').stop().animate({
        ...
        return location.hash = target.replace('#', '');
      });
    });
  };
  ...
  smallMenu = function() {
    if ($(window).width() <= 880) {
      return $header.addClass('is-small');
    } else {
      return $header.removeClass('is-small');
    }
  };

  openMenu = function() {
    $(document).ready(function() {
      return $header.removeClass('is-open');
    });
    $navbutton.click(function() {
      return $header.toggleClass('is-open');
    });
    return $header - link.click(function() {
      return $header.removeClass('is-open');
    });
  };
...
(function() {
  var $RndmElmts, PositionElmts, Stellar;

  $RndmElmts = $('span.funnythings');

  PositionElmts = function() {
    return $RndmElmts.each(function() {
      var left, top;
